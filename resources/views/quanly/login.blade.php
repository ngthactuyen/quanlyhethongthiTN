...
@section('content')
    {{--<div align="center">--}}
        ...
        if (isset($_SESSION['error_message'])){
            echo "<p style='color: red'  align = center>".$_SESSION['error_message']."</p>";
            unset($_SESSION['error_message']);
        }
        ?>
    <form class="form-horizontal" action="{{ route('quanly-authenticate') }}" method="post" class="form-horizontal">
